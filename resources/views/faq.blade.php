...
<section class="section-standard bg-gray-900">
    <div class="container-site max-w-4xl">
        <div class="space-y-6" x-data="{ openFaq: null }">
            ...
            <!-- FAQ Item 1 -->
            <div class="glass-card overflow-hidden transition-all duration-400">
                <button
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 1 ? 'faq-answer-enter' : ''"
                    >
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 2 ? 'faq-answer-enter' : ''"
                    >
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 3 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 4 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <h3 class="text-xl font-semibold text-white tracking-wide pr-4">
                        My license plate won't slide in easily—is something wrong?
                    </h3>
                    <svg
                        class="w-6 h-6 text-copper transition-transform duration-300"
                        style="color: var(--accent-copper);"
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 5 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 6 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 7 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 8 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
            ...
            <div class="glass-card overflow-hidden transition-all duration-400">
                ...
                >
                    <div
                        class="px-8 pb-8"
                        :class="openFaq === 9 ? 'faq-answer-enter' : ''"
                    >
                        <p class="text-gray-300 font-light leading-relaxed">
...
<style>
/* FAQ answer fade-in-from-left animation */
...
.faq-answer-enter {
    animation: fadeInFromLeft 500ms ease-out 150ms both;
}
</style>
