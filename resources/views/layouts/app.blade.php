...
<body class="antialiased text-gray-900" style="background-color: var(--bg-luxury-black); color: var(--text-primary);">
    ...
    <footer class="bg-linear-to-b from-black to-gray-900 border-t border-gray-800 section-compact">
        <div class="container-site">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-400 font-light">
                        ...
                        <li><a href="{{ route('faq') }}" class="link-underline transition" style="color: var(--text-muted);">FAQ</a></li>
            ...
            <div class="border-t border-gray-800 pt-8 pb-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div class="flex items-center gap-6">
                        <span class="text-gray-500 text-sm font-light hidden md:inline">Follow Us</span>
            ...
            <div class="border-t border-gray-800 pt-8 pb-0">
                <p class="text-gray-500 text-sm text-center font-light">
